        ...
        <div class="col-lg-4 mb-4">
            <div class="card position-relative">
                <span class="badge pack-badge {{ $pack==='premium'?'bg-warning text-dark':'bg-primary' }}">
                    @if($pack==='premium') <i class="fas fa-crown"></i> Premium @else <i class="fas fa-box"></i> Standard @endif
                </span>
                ...
                <div class="card-body">
                    ...
                    <ul class="list-unstyled">
                        <li><i class="fas fa-car text-primary"></i> Type: {{ $vehicule->type }}</li>
                        <li><i class="fas fa-gas-pump text-primary"></i> {{ $vehicule->carburant }}</li>
                        <li><i class="fas fa-users text-primary"></i> {{ $vehicule->nbre_places }} places</li>
                        <li><i class="fas fa-map-marker-alt text-primary"></i> {{ $vehicule->localisation }}</li>
                    </ul>
                    <hr>
