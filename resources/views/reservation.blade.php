            ...
            <div class="card reservation-card h-100">
                ...
                <div class="card-body">
                    ...
                    <form id="reservation-form" novalidate>
                        ...
                        <!-- Reste du formulaire … (adresse, paiement, conditions, bouton) -->
                        <hr class="my-4">
...
<script>
    ...
    form.addEventListener('submit', function(e){
        ...
        ['lastName','firstName','email','phone','birthDate','address','postalCode','city','country','cardholder','cardNumber','expiryDate','cvv','terms'].forEach(id => {
        ...
        if(valid){
            summary.innerHTML = `
                ...
                <p><strong>Adresse:</strong> ${document.getElementById('address').value}, ${document.getElementById('postalCode').value} ${document.getElementById('city').value}, ${document.getElementById('country').value}</p>
