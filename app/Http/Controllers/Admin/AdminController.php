...
// {
//     // Ici tu récupères le dernier véhicule soumis (ou une liste si tu veux)
//     $vehicule = Vehicule::latest()->first();
//     return view('admin.notification', compact('vehicule'));
// }

 public function notificationVehicule()
    {
        // Ici, on récupère tous les véhicules dont le statut est 'en_attente'
        $vehicules = Vehicule::where('statut', 'en_attente')->get();
   ...
   public function validerVehicule($id)
    {
        ...
        return redirect()->back()->with('success', 'Le véhicule a été validé et un mail a été envoyé au loueur.');
    }
}